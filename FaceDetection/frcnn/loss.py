...
from frcnn.augmentation import get_new_img_size
...
def class_loss_regr(num_classes):
    ...
    def class_loss_regr_fixed_num(y_true, y_pred):
        ...
        x_bool = K.cast(K.less_equal(x_abs, 1), 'int64')
        # print("x_bool :", x_bool)

        y_true = K.cast(y_true, 'float64')
        x_bool = K.cast(x_bool, 'float64')
        x_abs = K.cast(x_abs, 'float64')
        x = K.cast(x, 'float64')
        a = lambda_cls_regr * K.sum(
